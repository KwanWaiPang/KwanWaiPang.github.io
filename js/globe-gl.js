(function () {
  ...
  const TIME_CITIES = [
    ...
    { id: 'cai', name: 'Cairo', lat: 30.0444, lng: 31.2357, tz: 'Africa/Cairo', color: [0.95, 0.78, 0.35] },
    { id: 'rio', name: 'Rio de Janeiro', lat: -22.9068, lng: -43.1729, tz: 'America/Sao_Paulo', color: [0.45, 0.88, 0.55] },
  ...
  const VISITED = [
    ...
    // 贵州
    { id: 'gy', name: '贵阳', lat: 26.647, lng: 106.6302, color: [0.45, 0.78, 0.72] },
    { id: 'as', name: '安顺', lat: 26.2456, lng: 105.9476, color: [0.45, 0.78, 0.72] },
    { id: 'qn', name: '黔南', lat: 26.2594, lng: 107.5187, color: [0.45, 0.78, 0.72] },
    { id: 'qdn', name: '黔东南', lat: 26.5909, lng: 107.9811, color: [0.45, 0.78, 0.72] },
    // 广西
    ...
    { id: 'jdz', name: '景德镇', lat: 29.2686, lng: 117.1782, color: [0.95, 0.65, 0.45] },
    { id: 'lushan', name: '庐山', lat: 29.583, lng: 115.988, color: [0.95, 0.65, 0.45] },
    // 福建
    ...
    { id: 'wys', name: '武夷山', lat: 27.7567, lng: 118.0353, color: [0.5, 0.85, 0.95] },
    // 四川
    { id: 'cd', name: '成都', lat: 30.5728, lng: 104.0668, color: [0.85, 0.6, 1] },
    { id: 'ls', name: '乐山', lat: 29.5521, lng: 103.7654, color: [0.85, 0.6, 1] },
    { id: 'djy', name: '都江堰', lat: 31.0064, lng: 103.6472, color: [0.85, 0.6, 1] },
    // 广东
    ...
    // 上海
    { id: 'sh', name: '上海', lat: 31.2304, lng: 121.4737, color: [0.4, 0.8, 1] },
    // 香港
    {
      id: 'hk',
      name: '香港',
