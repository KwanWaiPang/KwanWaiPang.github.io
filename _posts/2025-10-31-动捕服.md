...
![](https://r-c-group.github.io/blog_media/images/nuoyiteng/850X850.PNG)

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/720X720.PNG)

B-pose：双手保持并拢状态，向上抬起约45°

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/720X720%20(1).PNG)

P-pose: 双手比出OK手势，大拇指与食指轻轻触碰，不要用力

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/aa70149d-7908-4f6d-8536-f07a28e39b1f.png)

T-pose: 手臂平举，掌心向下

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/81a739ec-69af-4825-91d7-a627e37713ee.png)

F-pose: 向前自然走出2-3步，转身返回起点A-Pose 站立，直到软件提示“正在计算校准结果”后可自由活动。此动作对于走路姿势没有严格要求，轻松自然走路即可，不要使劲跺脚、跳跃或快速奔跑。

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/d6b45b36-5637-405d-8fd0-4eaabbb4dea6.png)

# 数据录制与播放

下图的1\~3分别为：数据录制按钮、数据名称、数据备注信息

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/b6cd6eee-62a7-4db8-8004-dec6186d3cee.png)

选择了工程里相关的文件后，软件会自动切换到正上方的”编辑“ Tab里，进行数据的3D回放。软件底部有一个数据回放的播放按钮功能条，具体功能如下：

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/610fa22d-3561-4ebd-ac34-f29997b6ea8c.png)

数据导出则是用下面的按钮

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/e52d865c-3c0a-4f59-99e5-77e9afef6d27.png)
...
![](https://r-c-group.github.io/blog_media/images/nuoyiteng/9e88247b-3abb-4285-b63a-973a26cf903c.jpeg)

对应要设置ROS节点IP

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/07a0f3e0-8a64-49c1-bf51-14781a84c6cd.png)
...
![](https://r-c-group.github.io/blog_media/images/nuoyiteng/c77359c0-1209-425c-b9f3-0324bbbc33b3.png)
...
![](https://r-c-group.github.io/blog_media/images/nuoyiteng/ef7cbde7-a13b-445a-9cd8-b96878bf8eb8.png)

通过切换显示

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/51274bef-145b-4b76-8ee3-43fe61c0ddb9.png)

对于unitree\_h1\_ros2中的urdf模型如下（包含了19个关节）：

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/b78241e1-dbdc-4ef5-b8a6-8b15c9b101a2.png)

# 其他使用事项

传感器为27个，其中绿色代表能以较高信号强度接收传感器数据。红色与黄色为有无线频段干扰；灰色则是未开机或故障。

![](https://r-c-group.github.io/blog_media/images/nuoyiteng/024367f8-cfab-4b41-bc23-36f2fe696a4b.png)
