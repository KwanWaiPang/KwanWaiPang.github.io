...
author: kwanwaipang
toc: true
excerpt: "本博文系统整理了动态规划相关的知识与刷题笔记。"
---
...
故此，动态规划中每一个状态一定是由上一个状态推导出来的，这一点就区分于贪心算法<sup>[Link](/贪心算法/)</sup>，贪心没有状态推导，而是从局部直接选最优的，
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/算法学习笔记cpp rnL _页面_1.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/算法学习笔记cpp rnL _页面_2.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/算法学习笔记cpp rnL _页面_3.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240802212746.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240805214857.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240802214008.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240802214129.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240802214218.png" width="80%" />
<figcaption>  

</figcaption>
</div>

从两个子问题最优解 𝑑𝑝[𝑖 − 1] 和 𝑑𝑝[𝑖 − 2] 中挑选出较优的那一个，并用它构建出原问题 𝑑𝑝[𝑖] 的最优解。也就是**最优子结构**.
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240929164833.png" width="80%" />
<figcaption>  
...
另外一种解法(可以理解为第一步花费，最后一步不花费，是旧版这个题目的描述)
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240802214847.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240802215149.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240805220055.png" width="80%" />
<figcaption>  

</figcaption>
</div>

解法1：动态规划。时间复杂度O（N），空间复杂度为O（N）
...
用递归的思路解题也很简单。但是这个递归调用次数类似于计算一棵二叉树的节点数，树的高度为𝑛所以总的子树数目是O（2<sup>N</sup>），对应的时间复杂度为O（2<sup>N</sup>）。空间复杂度主要由递归调用的栈空间决定。每次递归调用都会占用一定的栈空间，递归的最大深度为𝑛，因此空间复杂度为：𝑂(N)
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/greedy_algorithm/微信截图_20240901215623.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240806204942.png" width="80%" />
<figcaption>  

</figcaption>
</div>

用了两个for循环，时间复杂度为O（N<sup>2</sup>）,空间复杂度为O（N）也就是存储的dp表
...
（用vector方便初始化，且涉及到循环对比的，需要先初始化，不然就会取空的时候的地址！）
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241015132230.png" width="80%" />
<figcaption>  
...
class Solution {
  public:
      int findLengthOfLCIS(vector<int>& nums) {
          ...
          if(nums.size()==1)//对于只有一个值的情况
              return 1;
  
          //step1:定义dp表.dp[i]对于第i个数字，递增子序列的最大长度为多少
          // 状态：当前位于第几个数字i,最大为nums.size()
          // 选择：若当前的比上一个大，那么就是之前的基础上+1
          ...
          {
              // 注意要连续的
              if(nums[i-1]>nums[i-2])//大于前一个
                  dp[i]=dp[i-1]+1;//上一个状态的值+1
              
              // 否则就是1
  
              if(dp[i]>max_len)//记录全部的最大值
                  max_len=dp[i];
          }
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240820-100411.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240813-134758.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240806214015.png" width="80%" />
<figcaption>  

</figcaption>
</div>

此题相当于最长递增子序列的二维版本，但是需要对数组先进行排列。但是leetcode上下面代码运行会超时，只能通过85/87.时间复杂度为O（N<sup>2</sup>）,空间复杂度为O（N）
...
二分法解题将复杂度降低为O（NlogN）这个方法还不是很熟悉～
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241008174806.png" width="80%" />
<figcaption>  

</figcaption>
</div>

某种程度上跟最长递增子序列的结构是一样的。解题的关键在于设计的状态是拆分数字i，而不是拆分为i个。只有这样才满足递推关系。其次就是对于每个数有拆与不拆两种选择
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/others/微信截图_20240901205402.png" width="80%" />
<figcaption>  
...
此题也可以用贪心算法来解决<sup>[Link](/贪心算法/#摆动序列)</sup>
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240929-214426.png" width="80%" />
<figcaption>  

</figcaption>
</div>

机器人从(0 , 0) 位置出发，到(m - 1, n - 1)终点。这点最重要！
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240819-105641.png" width="80%" />
<figcaption>  

</figcaption>
</div>

如若按照上一题的思路，此题应该是有问题的，n，m的格子。终端是（n-1,m-1）
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240929-220251.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240825-143229.png" width="80%" />
<figcaption>  

</figcaption>
</div>

时间与空间复杂度都是O（N<sup>2</sup>）
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240826160245.png" width="80%" />
<figcaption>  

</figcaption>
</div>

dp表的初始化容易出错，对于第i行第j列的dp标索引应该从0开始，从1开始其实也可以只是对应处理更加复杂而已~
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240826161711.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241017201759.png" width="80%" />
<figcaption>  

</figcaption>
</div>

编辑距离入门级题目。本质上就是只有删除这一个操作
...
class Solution {
  public:
      bool isSubsequence(string s, string t) {
          ...
          //step1：定义dp表。dp[i][j]s的第i个字符与t的第j个字符是否子序列
          // 状态：s的第i个字符与t的第j个字符（从1开始，到size()+1,这样就不用处理初始化问题）
          // 选择：等或不等，
          vector<vector<bool>> dp(s.size()+1, vector<bool>(t.size()+1, false));
  
          // step2:初始化全为false
          dp[0][0]=true;//全为空必然为子序列
          for(int j=1;j<t.size()+1;j++)
          {
              dp[0][j]=true;//s为空，那么s必然是t的子序列
          }
          ...
          for(int i=1;i<s.size()+1;i++)
          {
              for(int j=1;j<t.size()+1;j++)
              {
                  if(s[i-1]==t[j-1])//若两个字符相等
                      dp[i][j]=dp[i-1][j-1];//退化为上一个状态
                  else//若不等
                      dp[i][j]=dp[i][j-1];//应该删掉，再检查
              }
          }
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241017203253.png" width="80%" />
<figcaption>  

</figcaption>
</div>

也是编辑距离类型的题目，但只有删除的操作
...
class Solution {
  public:
      int numDistinct(string s, string t) {
          ...
          //step1:定义dp表。dp[i][j]s的第i个字符与t的第j个字符的时候，s到t的方案数
          // 状态：s的第i个字符与t的第j个字符（从1开始，到size()+1,这样就不用处理初始化问题）
          // 选择：删或不删
          vector<vector<unsigned long>> dp(s.size()+1, vector<unsigned long>(t.size()+1, 0));
          // unsigned long处理极大的数组的情况
  
          //step2:初始化dp表
          dp[0][0]=1;
          for(int i=1;i<s.size()+1;i++)
          {
              dp[i][0]=1;//当t为空时，有且只有一种方案由s到t，就是s全部删掉
          }
          ...
          for(int i=1;i<s.size()+1;i++)
          {
              ...
              {
                  if(s[i-1]==t[j-1])//若两个字符相等
                      dp[i][j]=dp[i-1][j-1]+dp[i-1][j];//退化为上一个状态，或者删掉s再检测（方案数为两者之和）
                  else//若不等
                      dp[i][j]=dp[i-1][j];//当前字母s删掉
              }
          }
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241017210134.png" width="80%" />
<figcaption>  

</figcaption>
</div>

只是上面一题的进阶版，改为两个字符都可以删减了~
...
class Solution {
  public:
      int minDistance(string word1, string word2) {
          ...
          //step1:定义dp表。dp[i][j]word1的第i个字符与word2的第j个字符的时候，s到t的最小步数
          // 状态：word1的第i个字符与word2的第j个字符（从1开始，到size()+1,这样就不用处理初始化问题）
          // 选择：删或不删
          vector<vector<int>> dp(word1.size()+1, vector<int>(word2.size()+1, INT_MAX));
  
          //step2:初始化dp表，上面定义的时候都初始化为最大值
          dp[0][0]=0;
          // 若只有其中之一为空
           ...
           for(int i=1;i<word1.size()+1;i++)
              {
                  for(int j=1;j<word2.size()+1;j++)
                  {
                      if(word1[i-1]==word2[j-1])//若两个字符相等
                          dp[i][j]=dp[i-1][j-1];//退化为上一个状态，不操作，必然是最小的
                      else//若不等,两种选择之一的最小
                          dp[i][j]=min(
                              dp[i-1][j]+1,//删掉i的操作数
                              dp[i][j-1]+1//删掉j的操作数
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240805215323.png" width="80%" />
<figcaption>  
...
（此题中，注释相对比较规范化了动态规划问题的解题~）时间复杂度O（M*N），空间复杂度为O（M*N）
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240818-104800.png" width="80%" />
<figcaption>  

</figcaption>
</div>

，跟字符串编辑距离很像，只是有了其他字符因此对初始化会有影响！
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241017211420.png" width="80%" />
<figcaption>  

</figcaption>
</div>

双指针法比较直接，见下题最长回文子串，此处仅用动态规划来解题
...
class Solution {
  public:
      int countSubstrings(string s) {
          ...
          // step1:定义dp表：dp[j][i]=起点为j终点为i的字符它是否为回文子串
          // 状态：起点为j终点为i的字符(i从0开始，到s.size()-1)
          vector<vector<bool>> dp(s.size(),vector<bool>(s.size(),false));
  
          // step2:初始化dp表，初始化为false
  
          //step3:进行状态转移
          int result=0;//总的回文子串数目
          for(int i=0;i<s.size();i++)//注意遍历的顺序，i为终点
          {
              for(int j=0;j<=i;j++)//j为从0~i
              {
                  if(i==j)//自身必然是回文子串
                  {
                      dp[j][i]=true;
                  ...
                  {
                      dp[j][i]=(s[i]==s[j]);
                      if(dp[j][i]==true)//若是回文子串
                          result++;
                  }
                  else //i与j相差大于1
                  {
                      dp[j][i]= (s[i]==s[j]) && dp[j+1][i-1];//从小范围到大范围
                      if(dp[j][i]==true)//若是回文子串
                          result++;
                  }
...
class Solution {
  public:
      int countSubstrings(string s) {
          ...
          // step1:定义dp表：dp[i][j]=起点为i终点为j的字符它是否为回文子串
          // 状态：起点为i终点为j的字符(i从0开始，到s.size()-1)
          vector<vector<bool>> dp(s.size(),vector<bool>(s.size(),false));
          ...
          //step3:进行状态转移
          int result=0;//总的回文子串数目
          for(int i=s.size()-1;i>=0;i--)//注意遍历的顺序，i为起点，从后往前遍历
          {
              for(int j=i;j<s.size();j++)//j为终点
              {
                  if(i==j)//自身必然是回文子串
                  {
                      dp[i][j]=true;
                  ...
                  {
                      dp[i][j]=(s[i]==s[j]);
                      if(dp[i][j]==true)//若是回文子串
                          result++;
                  }
                  else //i与j相差大于1
                  {
                      dp[i][j]= (s[i]==s[j]) && dp[i+1][j-1];//从小范围到大范围
                      if(dp[i][j]==true)//若是回文子串
                          result++;
                  }
...
也可以采用双指针解法。时间复杂度是O（N^2）更上面一样的。但空间复杂度更小，为O（1）
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241017215216.png" width="80%" />
<figcaption>  
...
class Solution {
  public:
      int longestPalindromeSubseq(string s) {
       ...
       // step1:定义dp表：dp[i][j]=字符串s在[i, j]范围内，最长的回文子序列长度
      // 状态：起点为i终点为j的字符(i从0开始，到s.size()-1)
      vector<vector<int>> dp(s.size(),vector<int>(s.size(),0));
  
      // step2:初始化dp表，自身必然是回文子串
      for(int i=0;i<s.size();i++)
          dp[i][i]=1;
  
      //step3:进行状态转移
      for(int i=s.size()-1;i>=0;i--)//注意遍历的顺序，i为起点
      {
          for(int j=i+1;j<s.size();j++)//j为终点(j=i的情况上面考虑了)
          {
              if(s[i]==s[j])
                  dp[i][j]= dp[i+1][j-1]+2;//数目增大了两个
              else//可以选择删除一个字符（也就是少对比一个）
                  dp[i][j]=max(dp[i+1][j],dp[i][j-1]);//两者的最大值
          }
      }
      return dp[0][s.size()-1];//i为起点，j为终点。
      }
  };
```
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240818-113759.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241015142118.png" width="80%" />
<figcaption>  
...
class Solution {
  public:
      int findLength(vector<int>& nums1, vector<int>& nums2) {
          ...
          // step1:定义dp表。dp[i][j],对于nums1中第i个数字与nums2中第j个数字，最长的公共子串的数
          // 状态：nums1中第i个数字与nums2中第j个数字(从1开始，对应选取的为nums1[i-1]和nums2[j-1])
          //而这样定义就不需要考虑初始化的问题了，否则如果以0开始，那么初始化就要检查nums1[0]和nums2[0]是否相等
          ...
          //step3：进行状态转移
          int max_len=0;//用于记录最长的长度
          for(int i=1;i<nums1.size()+1;i++)
          {
              for(int j=1;j<nums2.size()+1;j++)
              {
                  if(nums1[i-1]==nums2[j-1])
                      dp[i][j]=max(dp[i][j], dp[i-1][j-1]+1);//记录最长的
                  else//两者不相等
                      dp[i][j]=0;
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241016112446.png" width="80%" />
<figcaption>  

</figcaption>
</div>

注意要的是子序列，不是子串。不要求连续的了，只是需要有相对顺序
...
class Solution {
  public:
      int longestCommonSubsequence(string text1, string text2) {
          ...
          // step1:定义dp表。dp[i][j]=对于text1中的第i个字母，text2中的第j个字母，他们所对应的公共子序列最大长度
          // 状态：对于text1中的第i个字母，text2中的第j个字母（j从1开始。size()+1）
          // 选择：两个相等就+1，。不等就清0~
          vector<vector<int>> dp(text1.size()+1, vector<int>(text2.size()+1,0));
  
          // step2:初始化dp表，都初始化为0了，注意i从1开始，所以不用考虑第一个的情况
  
          //step3:进行状态转移
          int max_len=0;//记录最长的字符
          ...
          for(int i=1;i<text1.size()+1;i++)
          {
              for(int j=1; j<text2.size()+1;j++)
              {
                  if(text1[i-1]==text2[j-1])//若相等
                      ...
                      dp[i][j]=max(dp[i][j-1],dp[i-1][j]);//若不等，但最大应该还是删除这个后的最大值
  
                  // 注意dp[i][j]已经一直更新记录全部的最大子序列长度，因此无需额外记录
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241016122859.png" width="80%" />
<figcaption>  

</figcaption>
</div>

直线不能相交，这就是说明在字符串A中 找到一个与字符串B相同的子序列，且这个子序列不能改变相对顺序，只要相对顺序不改变，链接相同数字的直线就不会相交。（本质上跟上一题“最长公共子序列”是一模一样的）
...
class Solution {
  public:
      int maxUncrossedLines(vector<int>& nums1, vector<int>& nums2) {
          ...
          //step1:定义dp表.dp[i][j]=对于nums1的第i个数字与nums2的第j个数字对应的最大连线数
          // 状态:对于nums1的第i个数字与nums2的第j个数字
          //选择:连线或不连线
          vector<vector<int>> dp(nums1.size()+1, vector<int>(nums2.size()+1,0));
  
          // step2:初始化dp表,上面都初始化为0了
          ...
          for(int i=1;i<nums1.size()+1;i++)
          {
              for(int j=1;j<nums2.size()+1;j++)
              {
                  if(nums1[i-1]==nums2[j-1])//相等,那么就可以选择连或不连
                      // dp[i][j]=max(
                      //     dp[i-1][j-1]+1, //连了
                      //     max(dp[i-1][j],dp[i][j-1])//不连,任意保留一个的最大值
                      // );
                      dp[i][j]=dp[i-1][j-1]+1;//上面写法也可以,一模一样的
                  else//不等,那么只能不连,但是不连是分为放弃哪个的
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241008190954.png" width="80%" />
<figcaption>  
...
* 对于状态，如何才能描述一个问题局面？只要给几个物品和一个背包的容量限制，就形成了一个背包问题呀。所以状态有两个，就是「背包的容量」和「可选择的物品」。因此需要用二维数组。

* 对于选择，选择就是「装进背包」或者「不装进背包」。只有两种。
...
第二步需要确定初始的状态。那么就是`dp[0][..] = dp[..][0] = 0`，因为没有物品或者背包没有空间的时候，能装的最大价值就是 0。
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240826-092925.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241009142950.png" width="80%" />
<figcaption>  
...
当然，用动态规划去解题也是可以的。但是对于j为什么要从0开始理解得不是很透彻，且比回溯算法的思路复杂多了~
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241011194419.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20240805222949.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240826-102658.png" width="80%" />
<figcaption>  

</figcaption>
</div>

，题目跟上面很类似的，但此处不是求最优子问题，求解是总共有多少数目可以填满，可以转换为背包问题

此处有一个细节点，是先遍历物体在遍历背包的容量（跟下面的`组合总和 Ⅳ`相反）
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241011210158.png" width="80%" />
<figcaption>  

</figcaption>
</div>

第一个思路也是用回溯算法去解此题（相当于无重可复选的情况），但由于是排列情况，计算时间非常大，会导致超时
...
采用动态规划解题，注意也不能用《零钱兑换 II》中的解法1（背包问题）的思路去解题，因为顺序不一样，算不同的组合数！
...
class Solution {
  public:
      int combinationSum4(vector<int>& nums, int target) {
          ...
          //step2:初始化dp表
          //当物体数为0的时候为0（上面已经初始化了）
          for(int i=0;i<nums.size() + 1;i++)
          {
              dp[i][0]=1;//对于目标金额为0，什么都不做就是一种做法，直接可以凑出
          }
  
          //step3:进行状态转移（为了得到的是排列数，因此先遍历容量，再到物体）
          for(int j=0;j<target+1;j++)//遍历金额
          {
              for(int i=1;i<nums.size() + 1;i++)//遍历物体
              {
                  ...
                  || dp[i-1][j] > INT32_MAX-dp[nums.size()][j-nums[i-1]]  //测试用例有两个数相加超过int的数据,因此超过就默认不选
                      ...
                      // dp[i][j]=dp[i-1][j]+dp[i][j-nums[i-1]];//不选和选各一种方案（这是错的，对应出来只是组合数）
                      dp[i][j]=dp[i-1][j]+dp[nums.size()][j-nums[i-1]];//不选和选各一种方案
                      // 而对于选，应该是从nums.size()中选的，而不是单纯的i
...
用一维数组也可以解决，但是如果是int的话可能越界，因此用long形
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241012112254.png" width="80%" />
<figcaption>  
...
class Solution {
  public:
      int numSquares(int n) {
          ...
          //对于和为n，可以理解为从1~n个数，每个数i^2作为可以选的物体，
          // 且物体（数）可以被选择多次，也就是完全背包问题
          // 进一步地，可选的i^2必然是小于等同于n的
  
          int range=sqrt(n);//向下取整
  
          //step1：定义dp表：dp[i][j]=对于物体i，容量为j，最少的数量
          // 状态，物体i，背包的容量为n
          // 选择，物体i选或不选。对应的重量为i^2；范围为1~range
          vector<vector<int>> dp(range+1, vector<int>(n+1,INT_MAX));//由于取最小值，因此统一初始化为最大值
  
          // step2:初始化dp表
          //当1=1的时候，数值应该是正好等于容量值的
          for(int j=1;j<n+1;j++)
          {
              dp[1][j]=j;//j个1
          }
          ...
          //当j=0的时候，可以选的数量为0（注意题目说了从1开始的）
          for(int i=1;i<range+1;i++)
          {
              dp[i][0]=0;
          }
  
          // step3：进行状态转移（先物品，后背包，因此为组合数）
          for(int i=2;i<range+1;i++)//遍历物品
          {
              for(int j=1;j<n+1;j++)//遍历背包
              {
                  if(j-i*i<0)//不能选当前值
                      ...
                      dp[i][j]=min(
                          dp[i][j], min(
                              dp[i-1][j],//不选当前值
                              dp[i][j-i*i]+1//选了当前值，那么当前值还可以再选,注意，选了数目需要+1
                          )
                      );
              }
          }
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241013124222.png" width="80%" />
<figcaption>  

</figcaption>
</div>

跟顺序有关，故此必然是先遍历背包，再遍历物体

同时注意是`dp[wordDict.size()][j-wordDict[i-1].size()]`而不是`dp[i][j-wordDict[i-1].size()]`，因为是从所有的单词中找，而不是当前的单词中找
...
class Solution {
  public:
      bool wordBreak(string s, vector<string>& wordDict) {
          ...
          //step1：定义dp表。dp[i][j]=对于第i个物品，当前字符串所以为j的时候，是否拼接
          // 状态：选择物品i，j当前到第几个单词(字符串为背包容量)
          // 选择：当前物品/单词，选或不选
          vector<vector<bool>> dp(wordDict.size()+1, vector<bool>(s.size()+1,false));
  
          // step2:初始化dp表
          // 对于j=0，也就是目标字符串为0的时候，肯定是可以拼接的（什么都不做）
          for(int i=0;i<wordDict.size()+1;i++)
          {
              dp[i][0]=true;
          }
  
          //step3:进行状态转移（由于本题跟顺序有关，故此必然是先遍历背包，再遍历物体）
          for(int j=1;j<s.size()+1;j++)//遍历背包容量
          {
              for(int i=1;i<wordDict.size()+1;i++)//遍历物体
              {
                  if(j<wordDict[i-1].size())//也就是剩余容量的尺寸小于当前单词的尺寸，当前物品不能用
                      dp[i][j]=dp[i-1][j];
                  else
                  {
                      //查看在0~j这个位置上，是否能找到wordDict[i-1]
                      // string sub_str=s.substr(0,j);//先截取当前的字符串（当前背包的容量）
                      // if(sub_str.find(wordDict[i-1])!=string::npos)//找到了，但是不一定是末尾的字符
                      string sub_str = s.substr(j - wordDict[i-1].size(), wordDict[i-1].size());
                      if(sub_str==wordDict[i-1])//要严格是最后一个
                      {//当前字符用或不用中有true即为true
                           dp[i][j]=dp[i-1][j] //不用当前单词
                                  || dp[wordDict.size()][j-wordDict[i-1].size()];//用了当前单词，还可以继续从所有单词中找（但是用了剩余容量要减去长度）
  
                      }//若找不到，就是当前字符不能用，那么就等于上一状态的
                      else
                          dp[i][j]=dp[i-1][j];
                  }
              }
          ...
          return dp[wordDict.size()][s.size()];
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/WX20240813-090109.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241013153726.png" width="80%" />
<figcaption>  
...
class Solution {
  public:
      int rob(vector<int>& nums) {
          ...
          //当前屋偷与不偷由前一个房屋和前两个房屋是否被偷
  
          // step1：定义dp组。dp[i]，位于房屋i的时候最高的金额数
          // 状态：当前第i个房屋
          // 选择，该房屋偷或不偷
          ...
          for(int i=2;i<nums.size()+1;i++)
          {
              dp[i]=max(
                  dp[i-1],//前一个偷了，当前不能偷
                  dp[i-2]+nums[i-1]//前一个没偷，那么就是dp[i-2]+当前偷了获取的价值
              );            
          }
...
class Solution {
  public:
      int rob(vector<int>& nums) {
          ...
          //step2:初始化dp组
          dp[1][0]=0;//1的时候，不偷，那么金额数为0
          dp[1][1]=nums[0];//1的时候偷了，那么金额数为nums[0]
  
          //step3：进行状态转移
          for(int i=2;i<nums.size()+1;i++)
          {
              // dp[i][0]=dp[i-1][1];//当前不偷，那么必然是因为上一个时刻偷了
              dp[i][0] = max(dp[i-1][0], dp[i-1][1]);  // 当前不偷，那么上一个时刻可以偷了，也可以没偷，二者最大值！
              dp[i][1]=dp[i-1][0]+nums[i-1];//当前偷了，那么必然是上一个时刻没偷,同时加上当前时刻的价值
          }
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241013160348.png" width="80%" />
<figcaption>  
...
class Solution {
  public:
      ...
      int robrange(vector<int>& nums, int start, int end) {//原本可以理解为start=0； end为nums.size()
          ...
          //step2:初始化dp组
          // 0的时候没有偷，故此初始化了为0
          dp[start+1]=nums[start];//1的时候，偷了金额数肯定是最大的
      ...
      int rob(vector<int>& nums) {
          ...
          if (nums.size() == 1) 
              return nums[0];//对于size数目为1的话，下面result1会报错
          
          //由于是成环的，因此首元素和尾元素不能同时偷
          int result1=robrange(nums, 0, nums.size()-1);//考虑首元素，不考虑尾元素
          int result2=robrange(nums, 1, nums.size());//不考虑首元素，考虑尾元素
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/dynamic_programming/微信截图_20241013164126.png" width="80%" />
<figcaption>  

</figcaption>
</div>

本题其实是在上面两题的基础上把数据结构改成了树的形式

对于树的话，首先就要想到遍历方式，前中后序（深度优先搜索）还是层序遍历（广度优先搜索）。详细请见博客<sup>[Link](/二叉树类题目/)</sup>

注意 `vector<int>{0,0}` 或 `vector<int> a(2,0)` 都是两个0的vector，
...
class Solution {
public:
    //dp表：0为当前节点无被偷，1为当前节点被偷
    vector<int> traverse(TreeNode* root)
    {
        if(root==nullptr)//到达根节点
            return vector<int>{0,0};//注意为中括号！！！

        vector<int> left_result=traverse(root->left);
        vector<int> right_result=traverse(root->right);

        // 后序位置
        //当前偷了，那么左与右必然都没有被偷,两者的最大值+当前偷的结果
        int cur_result_1=left_result[0]+right_result[0]+root->val;

        //当前没有偷，那么应该是：可以偷也可以不偷左右节点，则取较大的情况
        int cur_result_0=max(left_result[0],left_result[1])
                        +max(right_result[0],right_result[1]);

        return vector<int>{cur_result_0,cur_result_1};//注意为中括号！！！
    }

    int rob(TreeNode* root) {
        vector<int> result = traverse(root);
        return max(result[0],result[1]);//根节点偷与不偷
        // 由于每个节点只有偷与不偷两种状态，因此从末端到顶端，遍历统计根节点不偷与偷的情况
    }
};
```
...
这部分主要参考：[一个方法团灭 LeetCode 股票买卖问题](https://labuladong.online/algo/dynamic-programming/stock-problem-summary/)，不过原文确实写得比较差，此处给出本人总结的思路.

## k次交易
{: #k次交易 }

<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/others/微信截图_20240901224102.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/others/微信截图_20240901223808.png" width="80%" />
<figcaption>  

</figcaption>
</div>

此题相当于，只进行一次交易，相当于题目188中的 k = 1
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/others/微信截图_20240901223532.png" width="80%" />
<figcaption>  

</figcaption>
</div>

此题相当于题目188中的无限次交易。注意此处跟121题的区别其实只是当前持有时dp[i][1]，如果当前时买了，是否应该考虑之前的状态！只有一次交易则不用考虑，因为之前肯定不持有股票（必然没钱），但是如果时无限次交易则必须要考虑之前不持有股票的情况了（有可能已经有利润）。
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/others/微信截图_20240901224156.png" width="80%" />
<figcaption>  

</figcaption>
</div>

关键只是冷冻期就必须考虑当前持有可以是上次不持有然后当前买入。但是上次不持有就只能是上次的上次本来就不持有，而不能是上次卖出导致不持有，因为有冷冻期。因此需要针对i-2的情况额外初始化dp表
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/others/微信截图_20240901224239.png" width="80%" />
<figcaption>  

</figcaption>
</div>

只是在上一刻持有并当前需要卖出的时候，考虑手续费即可
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/others/微信截图_20240901223924.png" width="80%" />
<figcaption>  

</figcaption>
</div>

只是188题目中k=2的特例而已。当然此题也有简化版本，其实也就是把k的情况给列出来，不用维护数组而已，但是本人觉得还是应该按K次来计算，不然重新维护，更乱！
...
* [《代码随想录》](https://www.programmercarl.com/%E5%8A%A8%E6%80%81%E8%A7%84%E5%88%92%E7%90%86%E8%AE%BA%E5%9F%BA%E7%A1%80.html)
...
* [动态规划问题的讲解视频](https://www.bilibili.com/video/BV1XV411Y7oE/?vd_source=a88e426798937812a8ffc1a9be5a3cb7)
* [最优子结构原理和 dp 数组遍历方向](https://labuladong.online/algo/dynamic-programming/faq-summary/)
* [0-1背包问题](https://labuladong.online/algo/dynamic-programming/knapsack1/)
