...
# 感知的融合
将来自本体感知（proprioception）和外部感知（exteroception）的信息进行融合，以形成最优的状态估计。主要是两种融合范式：经典贝叶斯方法和隐式神经技术。
...
## 经典贝叶斯方法
经典融合方法基于贝叶斯原理，通过将先验状态信念与观测条件概率相结合来推导最优状态。分为两种主要的经典融合方法：卡尔曼滤波器和基于优化的方法。
...
除了基于贝叶斯的经典融合方法，深度神经网络也可以用于隐式地融合状态转换和观测信息。这一部分主要分为两种神经融合方法：基于多层网络的融合和基于Transformer的融合。
