...
* [NaVILA](https://arxiv.org/pdf/2412.04453)：面向足式机器人，上层模型输出中层指令，下层 RL 策略驱动电机。复现博客请见：[Link](https://kwanwaipang.github.io/NaVILA/)
* [Hydra-Nav](https://arxiv.org/pdf/2602.09972):单一VLM框架（Qwen2.5-VL-7B）实现在快慢双系统（快系统：高效低级别执行；慢系统：全局规划与时空推理）间自适应切换；真机部署于Unitree Go2四足机器人，通过非线性模型预测控制（NMPC）执行动作（推理在服务器上运行）
