...
此外，将计算资源加载到GPU的标准是该资源可以并行化的程度。并且也需要考虑到CPU和GPU之间数据迁移的耗时，不然会导致并行化加速并没有带来增益。
...
1. 加速双目特征匹配（基于pinhole或者鱼眼相机的）；
2. 搜索当前帧中的局部map point
...
<div align="center">
  <table style="border: none; background-color: transparent;">
    <tr align="center">
      <td style="width: 35%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <img src="../images/WX20251002-163753.png" width="100%" />
      </td>
      <td style="width: 65%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <img src="../images/WX20251002-163813.png" width="100%" />
      </td>
    </tr>
  </table>
  <figcaption>
