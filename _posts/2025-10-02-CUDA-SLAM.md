...
|2025|`RAL`|[FAST-LIVO2 on Resource-Constrained Platforms: LiDAR-Inertial-Visual Odometry with Efficient Memory and Computation](https://arxiv.org/pdf/2501.13876)|---|RK3588|
|2025|`ACM Transactions on Graphics`|[Resolution Where It Counts: Hash-based GPU-Accelerated 3D Reconstruction via Variance-Adaptive Voxel Grids](https://arxiv.org/pdf/2511.21459)|[![Github stars](https://img.shields.io/github/stars/rvp-group/mrhash.svg)](https://github.com/rvp-group/mrhash)|[website](https://rvp-group.github.io/mrhash/)|
|2025|`arXiv`|[InstantSfM: Fully Sparse and Parallel Structure-from-Motion](https://arxiv.org/pdf/2510.13310)|[![Github stars](https://img.shields.io/github/stars/cre185/InstantSfM.svg)](https://github.com/cre185/InstantSfM)|[website](https://cre185.github.io/InstantSfM/)|
|2025|`Proceedings of the 30th ACM International Conference on Architectural Support for Programming Languages and Operating Systems`|[SuperNoVA: Algorithm-Hardware Co-Design for Resource-Aware SLAM](https://dl.acm.org/doi/pdf/10.1145/3669940.3707258)|[![Github stars](https://img.shields.io/github/stars/ucb-bar/SuperNoVA.svg)](https://github.com/ucb-bar/SuperNoVA)|---|
|2025|`arXiv`|[TurboMap: GPU-Accelerated Local Mapping for Visual SLAM](https://arxiv.org/pdf/2511.02036)|[![Github stars](https://img.shields.io/github/stars/sfu-rsl/TurboMap.svg)](https://github.com/sfu-rsl/TurboMap)|---|
...
|2024|`arXiv`|[Bundle Adjustment in the Eager Mode](https://arxiv.org/pdf/2409.12190)|[![Github stars](https://img.shields.io/github/stars/sair-lab/bae.svg)](https://github.com/sair-lab/bae)|---|
