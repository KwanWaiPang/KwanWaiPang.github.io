...
<!-- 定义全局样式 -->
<style>
  model-viewer[camera-controls] {  /* 仅影响带此属性的组件 */
    display: block;
    width: 100%;
    height: 500px;
    border-radius: 15px;
...
<div align="center">
  <table style="border: none; background-color: transparent;">
    <tr align="center">
      <td style="width: 50%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <model-viewer  src="https://kwanwaipang.github.io/ubuntu_md_blog/VGGT/testing1.glb"   alt="3D Model"  ar  auto-rotate  camera-controls  style="width: 100%; height: 400px;" ></model-viewer>
      </td>
      <td style="width: 50%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <model-viewer  src="https://kwanwaipang.github.io/ubuntu_md_blog/VGGT/testing2.glb"   alt="3D Model"  ar  auto-rotate  camera-controls  style="width: 100%; height: 400px;" ></model-viewer>
      </td>
    </tr>
  </table>
  <figcaption>
