...
<div align="center">
  <table style="border: none; background-color: transparent;">
    <tr align="center">
      <td style="width: 50%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <model-viewer  src="https://github.com/KwanWaiPang/vggt/raw/main/generate_glb/testing1.glb"   alt="3D Model"  ar  auto-rotate  camera-controls  style="width: 100%; height: 400px;" ></model-viewer>
      </td>
      <td style="width: 50%; border: none; padding: 0.01; background-color: transparent; vertical-align: middle;">
        <model-viewer  src="https://github.com/KwanWaiPang/vggt/raw/main/generate_glb/testing2.glb"   alt="3D Model"  ar  auto-rotate  camera-controls  style="width: 100%; height: 400px;" ></model-viewer>
      </td>
    </tr>
  </table>
  <figcaption>
...
* 单张图片
<model-viewer
  src="https://github.com/KwanWaiPang/vggt/raw/main/generate_glb/oneview.glb" 
  alt="3D Model"
  ar
  auto-rotate
  camera-controls
...
<model-viewer
  src="https://github.com/KwanWaiPang/vggt/raw/main/generate_glb/twoview_close.glb" 
  alt="3D Model"
  ar
  auto-rotate
  camera-controls
...
<model-viewer
  src="https://github.com/KwanWaiPang/vggt/raw/main/generate_glb/twoview_far.glb" 
  alt="3D Model"
  ar
  auto-rotate
  camera-controls
