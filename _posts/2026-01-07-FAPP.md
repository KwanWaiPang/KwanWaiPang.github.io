...
<div align="center">
  <img src="https://r-c-group.github.io/blog_media/images/微信截图_20260107133510.png" width="80%" />
<figcaption>  
</figcaption>
</div>
...
<div align="center">
  <img src="https://r-c-group.github.io/blog_media/images/微信截图_20260107134317.png" width="80%" />
  <img src="https://r-c-group.github.io/blog_media/images/微信截图_20260107135503.png" width="80%" />
<figcaption>  
</figcaption>
</div>

1. 动态目标跟踪：用离散线性系统与卡尔曼滤波器（KF）估计，如果某簇是新出现的，则新建一个 KF，若某簇能与已有第 i 个 tracker 关联，则把该簇的几何中心与帧差（中心的位移）作为测量向量 $Z_{i}$ 进入 KF 更新。
2. 当有多个检测（D 个障碍物）和多个 tracker（I 个跟踪目标），通过匈牙利算法（Hungarian Algorithm）寻找最优匹配组合。
3. 静态局部地图输出：其实就是把动态点集从当前点去删除。
...
# 参考资料
* [仅凭单个雷达在人群中稳定飞行！T-RO最新无人机避障算法FAPP](https://mp.weixin.qq.com/s/nrjIWLI3TfUIXH2wxCVqOw)
