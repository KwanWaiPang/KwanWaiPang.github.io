...
|2024|`arXiv`|[DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction](https://arxiv.org/pdf/2412.19584?)|[![Github stars](https://img.shields.io/github/stars/kai422/das3r.svg)](https://github.com/kai422/das3r)|[website](https://kai422.github.io/DAS3R/) <br> 采用MonST3R获取动静态点图，其中静态部分给到3DGS作为静态约束|
