---
layout: post
title: "采用双指针来解链表相关的题目"
date:   2026-04-14
tags: [Coding]
comments: true
author: kwanwaipang
toc: true
excerpt: "本博文汇总了采用双指针求解链表问题的算法笔记。"
---
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/单链表.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240711224621.png" width="80%" />
<figcaption>  

</figcaption>
</div>

原本我的解法是用递归去做的，对应的复杂度是`O(n+m)`
...
此处改为采用双指针去解。时间复杂度应该是一样的，但是空间复杂度不一样。上面的递归的空间复杂度为`O(n+m)`。递归调用函数时需要消耗栈空间，栈空间的大小取决于递归调用的深度。
而用双指针来解题，空间复杂度为`O(1)`。因为只需要常数的空间来存放若干变量。

理解过程如下动图所示：

<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/合并两个有序链表.gif" width="80%" />
<figcaption>  
...
注意上面解法返回的是`result->next`。采用的是「虚拟头结点」。

另外一种解法可以直接返回`result`，但是不采用虚拟头节点的话就要额外处理指针 p 为空的情况：
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240712193005.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240712210011.png" width="80%" />
<figcaption>  

</figcaption>
</div>

第一眼最基本的解法就是遍历(递归)用两两合并的方式。对于vector长度为k，每个链表最长的长度为n。第一次合并后，长度为n，第二次合并后为2n。第三次为3n，依次类推O（（1+k）k/2*n）那么就是O（k<sup>2</sup>*n）。空间复杂度为O（1）.
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240723193708.png" width="80%" />
<figcaption>  
...
但这样做的话需要两次遍历，能否**只遍历一次呢？**

思路请见下图：

<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240723190616.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/WX20240817-172403.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240723193755.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240723195438.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240723201154.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240723213212.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240723213729.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240723220051.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240724193035.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/2.gif" width="80%" />
<figcaption>  
...
关于递归类题目的介绍，请见博客[Link](/递归类题目/)

### 两数相加
{: #两数相加 }

<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240724183423.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240724184408.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240724185003.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240724185147.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/WX20240823-214906.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240724194709.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/微信截图_20240724201034.png" width="80%" />
<figcaption>  
...
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/WX20240817-161342.png" width="80%" />
<figcaption>  
...
* [解说视频](https://www.bilibili.com/video/BV1q94y1X7vy/?vd_source=a88e426798937812a8ffc1a9be5a3cb7)
* [双指针技巧秒杀七道链表题目](https://labuladong.online/algo/essential-technique/linked-list-skills-summary/)
* [My Leetcode](https://leetcode.cn/u/kwan-wai-pang/)
* 什么是双向链表(跟单向链表很像)？
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/双向链表.jpg" width="80%" />
<figcaption>  

</figcaption>
</div>
* 关于cpp中优先级队列如何使用，请见：[cpp中优先级队列的使用](https://blog.csdn.net/weixin_36888577/article/details/79937886)
<div align="center">
  <img src="https://kwanwaipang.github.io/Poster_files/learning_algorithm/Listnode/优先级队列.png" width="80%" />
<figcaption>  
