...
至于HAMT的训练，为了学习更好的视觉表证，则是先采用几个相似的task，通过end-to-end来训练，如基于模仿学习的single step action prediction，自监督的spatial relation prediction，masked language and image predictions and instruction trajectory matching。然后再通过RL来进行fine-tune，进一步提升导航的策略。
