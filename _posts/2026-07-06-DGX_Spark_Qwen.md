...
author: kwanwaipang
toc: true
excerpt: "记录在 NVIDIA DGX Spark 上部署 Qwen3.5 122B-A10B 模型，并通过混合量化、MTP 推测解码、INT8 LM Head 等技术将推理速度提升至 46.88 tok/s（相对于 baseline 28.3 tok/s 提升 65.6%）"
---
...
* Spark 与Thor的区别:
1. 虽然都是GB10芯片，但是Spark是3nn工艺，Thor是4nn工艺；
2. 功耗上Thor是120W，Spark是240W
3. CUDA核心：Spark是6144，Thor是2560
4. Tensor核心：Thor是96个（Spark是多少没查到，只说是Thor的两倍）
5. 通信带宽：Spark达200 Gbps，Thor应该只有20 Gbps左右
6. CPU：Spark是 20-core ARM、10 Cortex-X925 + 10 Cortex-A725 ARM ，Thor是14 核 Arm® Neoverse®-V3AE 64 位 CPU，主频2.6G
7. Spark与Thor的内存带宽都是273 GB/s，内存都是128G
8. Spark的CPU可以直接访问GPU的L2缓存，但是Thor不行
...
|Qwen3.6 35B-A3B (Spark)|  FP8                           | 40段      | 65G        | ---                                   | ---                                   | ---                    | ---                    | 75.4                       | 3.97s              |
